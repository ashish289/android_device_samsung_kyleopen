...
#
-include vendor/samsung/kyleopen/BoardConfigVendor.mk
...
BOARD_KERNEL_CMDLINE := androidboot.hardware=kyleopen
...
# Graphics
BOARD_EGL_CFG := device/samsung/kyleopen/prebuilt/system/lib/egl/egl.cfg
...
# RIL
BOARD_RIL_CLASS := ../../../device/samsung/kyleopen/ril/
...
# Recovery
TARGET_RECOVERY_INITRC := device/samsung/kyleopen/recovery/init.recovery.qcom.rc
TARGET_RECOVERY_FSTAB := device/samsung/kyleopen/recovery/fstab.qcom
